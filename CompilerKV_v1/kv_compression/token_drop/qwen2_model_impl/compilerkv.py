"""
CompilerKV: Qwen2 Flash Attention 2 Forward Implementation

Implements the attention forward with Stage1-Stage2-Stage3 KV compression
for Qwen2 models using Flash Attention 2.
"""
...
def qwen2_flash_attn2_forward_CompilerKV(
    self,
    ...
    """
    Qwen2 Flash Attention 2 forward with CompilerKV compression.
    """
